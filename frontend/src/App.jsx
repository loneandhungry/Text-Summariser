...
export default function App() {
  ...
  const handleSummariser = async () => {
    // your summariser logic
  };
        ...
        {isLoggedIn ? (
          <>
            ...
            <div className="w-full max-w-2xl mb-6 lg:mb-10">
              <div className="bg-[#fef3e7] border-2 border-[#92400e] rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-4 sm:p-6 flex flex-col items-center justify-center w-full">
            ...
            <div className="bg-[#fdf5ec] shadow-xl p-4 sm:p-6 lg:p-6 rounded-3xl border border-[#92400e] w-full max-w-2xl">
              ...
              <textarea
                ...
                className="bg-[#fef7e7] border-2 border-[#b45309] focus:border-[#92400e] focus:ring-2 focus:ring-[#b45309] outline-none rounded-xl w-full p-3 sm:p-4 resize-none transition-all duration-300 text-[#4b2e14] font-body"
              />
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-5 mt-3 sm:mt-4">
                <select
                  ...
                  className="bg-[#fcd34d] text-[#78350f] font-medium px-4 sm:px-5 py-2 border-2 border-[#b45309] rounded-full shadow-sm hover:bg-[#fbbf24] focus:ring-2 focus:ring-[#92400e] transition-all duration-300 font-body"
                >
                ...
                <button
                  ...
                  className="bg-[#b45309] hover:bg-[#78350f] text-white font-semibold px-8 sm:px-10 py-2 sm:py-3 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 font-body w-full sm:w-auto"
                >
              ...
              <textarea
                ...
                className="bg-[#fef7e7] text-[#4b2e14] border-2 border-[#b45309] rounded-xl w-full p-3 sm:p-4 mt-4 sm:mt-6 resize-none focus:outline-none font-body"
              />
            </div>
          </>
        ) : (
